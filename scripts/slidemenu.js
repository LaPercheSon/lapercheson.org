...
(() => {
  ...
  document.addEventListener('pointerup', () => { if (!down) return; down = false; if (active) location.href = active.getAttribute('href'); active = null; });
  ...
  document.addEventListener('touchend', () => { if (!down) return; down = false; if (active) location.href = active.getAttribute('href'); active = null; }, {passive:false});
})();
