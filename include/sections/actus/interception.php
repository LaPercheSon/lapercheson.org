<article id="interceptionArticle" class="actus_article">
    ...
    <div class="actus_article_col">
        <iframe class="actus_article_illustration" id="imgOneProject" src="https://www.youtube.com/embed/LD6vmeCJGw4?si=6_CzpwwD8VPa3Hkk" title="Teaser Interception sur YouTube" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
